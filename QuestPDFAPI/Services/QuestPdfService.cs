...
public static class QuestPdfService
{
    ...
    public static async Task<PdfReportFileInfoModel> GenerateSample1Pdf()
    {
        try
        {
            string customerInvestmentData = File.ReadAllText(@"./Assets/customer-investment-data.json");
            var investmentTradeInfo = JsonSerializer.Deserialize<InvestmentTradeInfoModel>(customerInvestmentData);
            ...
            return new PdfReportFileInfoModel()
            {
                ByteArray = pdfBytes,
    ...
    public static byte[] GeneratePharmacyReportBytes()
    {
        ...
        Document document = Document.Create(container =>
        {
            container.Page(page =>
            {
                ...
                page.Content()
                .Border(1)
                .Element(ComposePharmacyReportContent);
    ...
    private static List<PharmacyReportInfoModel> GetPharmacyReport()
    {
        var pharmacyReport = new List<PharmacyReportInfoModel>
            {
                new PharmacyReportInfoModel() { AmountDue = 65900.00, AmountPaid = 45350.00, CustomerId = "CUST/90/2891", CustomerName = "Ibrahim Hassan", Id = 1, TransactonDate = new DateTime(2024, 3, 19) },
                new PharmacyReportInfoModel() { AmountDue=4500, AmountPaid = 4500, CustomerId="CUST/23/8811", CustomerName = "Ayodeji Peter", Id=2, TransactonDate=new DateTime(2024, 4, 22) },
                new PharmacyReportInfoModel() { AmountDue=8900.34, AmountPaid = 8000, CustomerId="CUST/11/7399", CustomerName = "James Okuzor", Id=3, TransactonDate=new DateTime(2024, 6, 5) },
                new PharmacyReportInfoModel() { AmountDue=67500, AmountPaid = 67500, CustomerId="CUST/77/2833", CustomerName = "Olufemi Oyedepo", Id=4, TransactonDate=new DateTime(2024, 1, 5) },
                new PharmacyReportInfoModel() { AmountDue=20000, AmountPaid = 19800, CustomerId="CUST/14/8900", CustomerName = "Tessy Okotie", Id=5, TransactonDate=new DateTime(2024, 2, 10) },
                new PharmacyReportInfoModel() { AmountDue=1250, AmountPaid = 1250, CustomerId="CUST/92/2011", CustomerName = "Adewale Suleiman", Id=6, TransactonDate=new DateTime(2024, 2, 3) },
                new PharmacyReportInfoModel() { AmountDue=81320, AmountPaid = 81320, CustomerId="CUST/34/6500", CustomerName = "John Barnes", Id=7, TransactonDate=new DateTime(2023, 7, 7) },
                new PharmacyReportInfoModel() { AmountDue=48750, AmountPaid = 48750, CustomerId="CUST/11/4390", CustomerName = "Jabilla Muhammed", Id=8, TransactonDate=new DateTime(2024, 4, 2) },
                new PharmacyReportInfoModel() { AmountDue=32900, AmountPaid = 30000, CustomerId="CUST/34/1872", CustomerName = "Kolawole Emmanuel", Id=9, TransactonDate=new DateTime(2024, 2, 18) },
                new PharmacyReportInfoModel() { AmountDue=43500, AmountPaid = 23850, CustomerId="CUST/14/3390", CustomerName = "James Toney", Id=10, TransactonDate=new DateTime(2024, 3, 3) },
                new PharmacyReportInfoModel() { AmountDue=77000, AmountPaid = 77000, CustomerId="CUST/10/1019", CustomerName = "Gordon Davis", Id=11, TransactonDate=new DateTime(2024, 5, 5) },
                new PharmacyReportInfoModel() { AmountDue=2300, AmountPaid = 2300, CustomerId="CUST/28/2011", CustomerName = "Esteban Juan Rodriguez", Id=12, TransactonDate=new DateTime(2024, 8, 18) },
                new PharmacyReportInfoModel() { AmountDue=6750, AmountPaid = 4400, CustomerId="CUST/27/2899", CustomerName = "Jacques Du Plessis", Id=13, TransactonDate=new DateTime(2024, 1, 19) },
                new PharmacyReportInfoModel() { AmountDue=3200, AmountPaid = 950, CustomerId="CUST/29/9902", CustomerName = "Donald Mafa", Id=14, TransactonDate=new DateTime(2024, 8, 11) },
                new PharmacyReportInfoModel() { AmountDue=5000, AmountPaid = 5000, CustomerId="CUST/11/3381", CustomerName = "Angelo Gabriel", Id=15, TransactonDate=new DateTime(2024, 7, 23 )},
                new PharmacyReportInfoModel() { AmountDue=7800, AmountPaid = 7800, CustomerId="CUST/15/2401", CustomerName = "Naseem Muhammad", Id=16, TransactonDate=new DateTime(2024, 9, 30) },
                new PharmacyReportInfoModel() { AmountDue=65900, AmountPaid = 65700, CustomerId="CUST/15/6654", CustomerName = "Yu Xiao Ping", Id=17, TransactonDate=new DateTime(2024, 4, 4) },
                new PharmacyReportInfoModel() { AmountDue=25600, AmountPaid = 24000, CustomerId="CUST/13/8899", CustomerName = "Jane Ashcroft-Peters", Id=18, TransactonDate=new DateTime(2024, 8, 9) },
                new PharmacyReportInfoModel() { AmountDue=4000, AmountPaid = 4000, CustomerId="CUST/55/9109", CustomerName = "Ashley Nelly", Id=19, TransactonDate=new DateTime(2024, 7, 21) },
                new PharmacyReportInfoModel() { AmountDue=21000, AmountPaid = 5000, CustomerId="CUST/21/4300", CustomerName = "Simone Clemente", Id=20, TransactonDate=new DateTime(2024, 3, 28) },
            };


        var summary = new PharmacyReportInfoModel()
        {
